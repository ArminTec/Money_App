...
<br>
<br>
	<p style="text-align:center;"><a href="<?php echo APP_URL; ?>transactions/add">Agregar una transacción</a></p>
...
/*<?php echo date_format($date, "d/m/Y"); ?>*/
	?>
		<tr>
			...
			<td>  <a href="<?php echo APP_URL; ?>transactions/edit/<?php echo $transaction["0"]; ?>"><i class="small material-icons">Edit</i></a>
		        <a href="<?php echo APP_URL; ?>transactions/delete/?id=<?php echo $transaction["0"]; ?>"><i class="small material-icons">Delete</i></a>
  </td>
		</tr>
	<?php 
	$i++;
